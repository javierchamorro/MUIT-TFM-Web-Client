            ...
            <div className="user">
                ...
                <div className="info">
                    ...
                    <ul class="list-group list-group-horizontal mt-4">
                        ...
                        <div className="input-group col-md-4">
                            <select name="studies" className="custom-select" id="inputGroupSelect01" value={this.state.studies} onChange={this.onChangeStudiesText.bind(this)}>
                ...
                <div className="info">
                    ...
                    <ul class="list-group list-group-horizontal">
                        <div className="col-md-4"></div>
                        <div className="input-group col-md-4">
                            <select name="location" class="custom-select" id="inputGroupSelect01" value={this.state.location} onChange={this.onChangeLocationText.bind(this)}>
